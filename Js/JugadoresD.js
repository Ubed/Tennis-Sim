...
hombre3=["Almagro, Nicolas(ESP)",8,10,7,9,9,7,8,8,8,7,6,"clay"];
...
hombre15=["Berdych, Tomas(CZE)",9,7,8,7,7,7,9,8,8,7,9,"carpet"];
...
hombre41=["Djokovic, Novak(SRB)",9,9,7,9,8,9,8,9,9,9,9,"hardcourt"];
...
hombre45=["Federer, Roger(SUI)",9,10,8,9,7,8,9,8,9,8,8,"grass"];
hombre164 =["Felder, Marcel(URU)",6,8,5,7,6,6,5,6,7,7,10,"clay"];
hombre46=["Ferrer, David(ESP)",9,9,8,8,9,8,9,9,10,9,7,"clay"];
hombre47=["Ferrero, Juan Carlos(ESP)",8,8,8,8,6,7,7,8,8,8,7,"clay"];
hombre48=["Fish, Mardy(USA)",9,8,7,7,6,7,9,9,7,7,10,"hardcourt"];
...
hombre52=["Gasquet, Richard(FRA)",8,9,8,7,8,7,8,8,8,8,9,"clay"];
...
hombre94=["Melzer, Jurgen(AUT)",10,9,8,7,8,7,8,8,8,8,8,"clay"];
hombre95=["Monaco, Juan(ARG)",8,7,6,6,7,8,7,7,8,8,10,"clay"];
hombre96=["Monfils, Gael(FRA)",9,7,7,8,9,8,8,9,8,9,8,"clay"];
hombre97=["Montañés, Albert(ESP)",8,7,6,7,8,8,7,8,8,8,9,"clay"];
hombre98=["Murray, Andy(GBR)",10,10,8,8,9,9,9,9,9,9,9,"hardcourt"];
hombre99=["Nadal, Rafael(ESP)",10,9,8,8,10,8,9,10,10,9,8,"clay"];
...
hombre112=["Roddick, Andy(USA)",9,8,8,7,9,8,9,9,9,7,10,"hardcourt"];
...
hombre127=["Troicki, Viktor(SRB)",8,8,6,7,7,7,8,9,7,8,10,"carpet"];
...
hombre132=["Verdasco, Fernando(ESP)",9,7,7,7,8,7,8,8,9,7,6,"clay"];
hombre158 =["Volandri, Filippo(ITA)",6,8,8,8,7,6,6,7,6,7,10,"clay"];
hombre133=["Wawrinka, Stanislas(SUI)",8,10,7,7,7,7,9,8,8,7,9,"clay"];
hombre153 =["Young, Donald(USA)",7,6,6,5,7,5,7,7,6,7,10,"hardcourt"];
hombre134=["Yen-Hsun, Lu(TAP)",7,6,7,7,6,6,8,8,6,6,10,"hardcourt"];
hombre135=["Youzhny, Mikhail(RUS)",7,8,8,8,7,7,8,7,8,8,10,"hardcourt"];
